      ...
      <el-row :gutter="20">
        <el-col :span="8">
          <el-form-item label="一级分类" value="">
            <el-select v-model="cForm.category1Id" @change="handler1">
              <el-option
                :label="c1.name"
                :value="c1.id"
        ...
        <el-col :span="8">
          <el-form-item label="二级分类" value="">
            <el-select v-model="cForm.category2Id" @change="handler2">
              <el-option
                :label="c2.name"
                :value="c2.id"
        ...
        <el-col :span="8">
          <el-form-item label="三级分类" value="">
            <el-select v-model="cForm.category3Id" @change="handler3">
              <el-option
                :label="c3.name"
                :value="c3.id"
